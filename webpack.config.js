...
module.exports = function makeWebpackConfig() {
  ...
  if (!isTest) {
    ...
    config.entry = isTest ? {} : {
      ...
      'app': './resources/assets/typescript/boot.ts' // our angular app
    };
  }
  ...
  config.module = {
    rules: [
      ...
      {
        test: /\.css$/,
        exclude: root('resources/assets/typescript', 'app'),
        loader: isTest ? 'null-loader' : ExtractTextPlugin.extract({ fallback: 'style-loader', use: ['css-loader', 'postcss-loader']})
      },
      // all css required in src/app files will be merged in js files
      {test: /\.css$/, include: root('resources/assets/typescript', 'app'), loader: 'raw-loader!postcss-loader'},
      ...
      // all css required in src/app files will be merged in js files
      {test: /\.(scss|sass)$/, exclude: root('resources/assets/typescript', 'style'), loader: 'raw-loader!postcss-loader!sass-loader'},
  ...
  if (isTest && !isTestWatch) {
    ...
    config.module.rules.push({
      test: /\.ts$/,
      enforce: 'post',
      include: path.resolve('resources/assets/typescript'),
  ...
  config.plugins = [
    ...
    new webpack.ContextReplacementPlugin(
      ...
      root('./resources/assets/typescript') // location of your src
    ),
  ...
  if (!isTest && !isTestWatch) {
    config.plugins.push(
      ...
      new HtmlWebpackPlugin({
        template: './resources/assets/typescript/public/index.html',
  ...
  //if (isProd) {
    config.plugins.push(
      ...
      new CopyWebpackPlugin([{
        from: root('resources/assets/typescript/public')
      }])
    );
  //}
   ...
   */
  config.devServer = {
    contentBase: './resources/assets/typescript/public',
